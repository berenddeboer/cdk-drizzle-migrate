...
class DrizzleMigrateMariaDBIntegStack extends Stack {
  constructor(scope: App, id: string, props?: StackProps) {
    ...
    const dbSecurityGroup = new ec2.SecurityGroup(this, "DbSecurityGroup", {
      vpc,
      description: "Security group for the MariaDB test database",
    })
...
const app = new App()
new DrizzleMigrateMariaDBIntegStack(app, "DrizzleMigrateMariaDBIntegStack")
