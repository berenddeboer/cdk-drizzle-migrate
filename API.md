...
| <code><a href="#cdk-drizzle-migrate.DrizzleMigrate.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk-drizzle-migrate.DrizzleMigrate.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk-drizzle-migrate.DrizzleMigrate.with.parameter.mixins"></a>
